      ...
      try {
         ...
         dispatch(
            setToastAction({
               ...
               detail: "L'article a été supprimé avec succès",
               life: 3000,
            }),
         )
         fetchArticle(fetchedArticles)
         setSelectAll(false)
      ...
      <>
         ...
         <div className="px-4 py-3 main_content">
            <div className="d-flex align-items-center justify-content-between">
               <h1 className="mb-3">
                 <FormattedMessage id="articles.title" defaultMessage="Articles" />
               </h1>
               <Button
                 label={intl.formatMessage({ id: "articles.new", defaultMessage: "Nouveau article" })}
                 icon="pi pi-plus"
                 size="small"
            ...
            <div className="shadow my-2 bg-white p-3 rounded d-flex align-items-center justify-content-between">
               <div className="d-flex  align-items-center">
                  <div className="p-input-icon-left">
                     ...
                     <InputText
                       type="search"
                       placeholder={intl.formatMessage({ id: "search.placeholder", defaultMessage: "Recherche" })}
               ...
               <div className="selection-actions d-flex align-items-center">
                  ...
                  <a
                     ...
                     onClick={(e) =>
                        handleDeletePress(
                           e,
                           selectedItems ? selectedItems.map((item) => item.ID_ARTICLE) : [],
                        )
                     }
                  >
                     <svg
            ...
            <div className="content">
               <div className="shadow rounded mt-3 pr-1 bg-white">
                  ...
                  >
                     ...
                     <Column
                       field="IMAGE"
                       header={intl.formatMessage({ id: "articles.image", defaultMessage: "Image" })}
                       frozen
                       body={(item) => {
                          const css = `
                     ...
                     <Column
                       field="ID_ARTICLE"
                       header={intl.formatMessage({ id: "articles.id", defaultMessage: "Article ID" })}
                       frozen
                       sortable
                       body={(item) => {
                           return <span>{item.ID_ART}</span>
                        }}
                     />
                     <Column
                       field="DESCRIPTION"
                       header={intl.formatMessage({ id: "articles.description", defaultMessage: "DESCRIPTION" })}
                       frozen
                       sortable
                       body={(item) => {
                     ...
                     <Column
                       field=""
                       header={intl.formatMessage({ id: "actions", defaultMessage: "Actions" })}
                       alignFrozen="right"
                       frozen
                       body={(item) => {
                           const items = [
                              ...
                              },
                              {
                                 template: () => {
                                    return (
                                       <Link
                                          to={`/articles/edit/${inViewMenuItem?.ID_ARTICLE}`}
                                       ...
                                       >
                                          ...
                                          <span className="p-menuitem-text">
                                            {intl.formatMessage({ id: "edit", defaultMessage: "Modifier" })}
                                          </span>
                                       </Link>
                                    )
                                 },
                                 ...
                                 template: () => {
                                    return (
                                       <a
                                          ...
                                          onClick={(e) => handleDeletePress(e, [inViewMenuItem.ID_ARTICLE])}
                                       >
                                          <svg
                                             xmlns="http://www.w3.org/2000/svg"
                                             width="16"
                                          ...
                                          <span className="p-menuitem-text text-danger">
                                            {intl.formatMessage({ id: "delete", defaultMessage: "Supprimer" })}
                                          </span>
                                       </a>
                                    )
                                 },
